VERSION 5.00
Begin VB.Form TheGetIntegerDialog 
   ...
   End
End
Attribute VB_Name = "TheGetIntegerDialog"
...
Private Sub Form_Load()
    returnValue = Null
    Me.valueText.text = CStr(TheDialog.getDefaultValue())
...
Private Sub okButton_Click()
    returnValue = CStr(Me.valueText.text)
...
Private Sub valueText_Change()
    ...
    ' convert to string just in case it is in number.
End Sub
